        ...
        >
          ...
          <GlassCard className="p-8 mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Founded with a passion for quality and style, Arnova represents
              the perfect blend of contemporary fashion and timeless elegance.
              We believe that great style should be accessible to everyone,
              which is why we carefully curate our collections to offer premium
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <GlassCard className="p-6 text-center">
              ...
              <p className="text-muted-foreground">
                Committed to ethical and sustainable fashion practices
              </p>
            </GlassCard>
            <GlassCard className="p-6 text-center">
