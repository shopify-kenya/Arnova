...
import { fetchProducts, filterProductsByCategory } from "@/lib/products"
import {
  ProductGridEmpty,
  ProductGridSkeleton,
...
export default function AccessoriesPage() {
  ...
  let products = filterProductsByCategory(allProducts, "accessories")
              ...
              <div className="flex-1">
                ...
                {isLoading ? (
                  ...
                  <ProductGridEmpty
                    ...
                    description="We couldn't find any accessories matching your filters."
                  />
                ) : (
