...
import { fetchProducts, filterSaleProducts } from "@/lib/products"
import {
  ProductGridEmpty,
  ProductGridSkeleton,
...
export default function SalePage() {
  ...
  let products = filterSaleProducts(allProducts)
              ...
              <div className="flex-1">
                ...
                {isLoading ? (
                  ...
                  <ProductGridEmpty
                    ...
                    description="We couldn't find any sale items matching your filters."
                  />
                ) : (
