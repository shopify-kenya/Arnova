      ...
      <CurrencyProvider>
        <div className="min-h-screen flex">
          ...
          <main className="flex-1 ml-64 p-8">
            ...
            {/* Quick Actions */}
            <div className="mb-8">
              <h2 className="font-serif text-3xl font-bold text-foreground mb-6">Quick Actions</h2>
            ...
            <GlassCard className="p-6" strong>
              ...
              <div className="space-y-4">
                {[
                  { action: "New order placed", details: "Order #1234 - $129.99", time: "5 minutes ago" },
                  { action: "Product updated", details: "Premium Cotton T-Shirt", time: "1 hour ago" },
                  { action: "New customer registered", details: "john.doe@example.com", time: "2 hours ago" },
                  { action: "Order shipped", details: "Order #1230 - $89.99", time: "3 hours ago" },
                ].map((activity, index) => (
                  <div
                    key={index}
