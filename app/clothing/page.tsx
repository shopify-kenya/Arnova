...
export default function ClothingPage() {
  ...
  let products = getProductsByCategory("clothing")
      ...
      <div className="min-h-screen">
        ...
        <main className="container mx-auto px-4 py-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="mb-8">
              <h1 className="font-serif text-5xl font-bold text-foreground mb-2">Clothing</h1>
              <p className="text-muted-foreground">Premium apparel for every occasion</p>
            </div>
